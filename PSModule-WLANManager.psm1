...
function Enable-WLANAdapters
{
    ...
    $WLANAdapters = Get-WmiObject -Class Win32_NetworkAdapter | Where-Object {($_.Description -notlike "*VirtualBox*") -and ($_.Description -notlike "*VMware*") -and ($_.Description -like "*Wireless*") -and ($_.Description -notlike "*Hyper*") -and ($_.Description -notlike "*TAP*") -and ($_.Description -notlike "*Wireguard*") -and ($_.Description -notlike "*Wintun*") -or ($_.Description -like "*Wi-Fi*")}
    foreach ($WLANAdapter in $WLANAdapters)
        {
            ## Disable WLAN Adapter
            $WLANAdapter.Enable()
...
$NetworkConnectionsLAN = Get-WmiObject -Class Win32_NetworkAdapterConfiguration -Filter "IPEnabled=TRUE" | Where-Object {($_.Description -notlike "*VirtualBox*") -and ($_.Description -notlike "*VMware*") -and ($_.Description -notlike "*Wireless*") -and ($_.Description -notlike "*Wi-Fi*") -and ($_.Description -notlike "*Hyper*") -and ($_.Description -notlike "*TAP*") -and ($_.Description -notlike "*Wireguard*") -and ($_.Description -notlike "*Wintun*")}
